...
/*   Updated: 2026/06/28 13:04:01 by flora_nyah       ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int		ft_dl_lstsize(t_list *lst);
t_list	*ft_dl_lstlast(t_list *lst);
void	ft_dl_lstadd_back(t_list **lst, t_list *new);
void	ft_dl_lstdelone(t_list *lst, void (*del)(void*));
